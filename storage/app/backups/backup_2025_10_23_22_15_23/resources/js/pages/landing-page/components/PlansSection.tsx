                ...
                <div className="mb-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="bg-white/50 rounded-lg p-2 text-center">
                      <div className="text-lg font-bold" style={{ color: brandColor }}>{plan.stats?.businesses || 'N/A'}</div>
                    ...
                    <div className="bg-white/50 rounded-lg p-2 text-center">
                      <div className="text-lg font-bold" style={{ color: brandColor }}>{plan.stats?.templates || '34'}</div>
                      <div className="text-xs text-muted-foreground">{t("Templates")}</div>
                    </div>
                    <div className="bg-white/50 rounded-lg p-2 text-center">
                      <div className="text-lg font-bold" style={{ color: brandColor }}>{plan.stats?.bio_links || 'N/A'}</div>
                      <div className="text-xs text-muted-foreground">{t("Bio Links")}</div>
                    </div>
                    <div className="bg-white/50 rounded-lg p-2 text-center">
                      <div className="text-lg font-bold" style={{ color: brandColor }}>{plan.stats?.bio_links_templates || '14'}</div>
                      ...
                      <div className="bg-white/50 rounded-lg p-3">
                        ...
                        <div className="flex flex-wrap gap-1">
                          {plan.stats.addon_names.map((name, index) => (
                            <span key={index} className="inline-block bg-white px-2 py-1 rounded text-xs font-medium" style={{ color: brandColor }}>
                              {name}
                            </span>
                          ))}
                        </div>
