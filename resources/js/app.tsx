...
import { registerOneSignalSubscription } from './utils/pushNotifications';
...
// Add event listener for theme changes (cross-browser, incl. older iOS Safari)
(() => {
    ...
    // Use modern API if available, fall back to legacy addListener for older Safari
    if (typeof (mediaQuery as any).addEventListener === 'function') {
        (mediaQuery as any).addEventListener('change', handleChange);
