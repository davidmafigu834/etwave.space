...
const ProductsEdit: React.FC<ProductsEditProps> = ({ business, product, categories }) => {
  ...
  const submit = (e: React.FormEvent) => {
    e.preventDefault();
    put(route('ecommerce.products.update', [business.id, product.id]));
  };
    ...
    <AppSidebarLayout>
      ...
      <div className="py-6">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-gray-900">Edit Product - {business.name}</h2>
          <Link 
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <span className="ml-2 text-gray-900">{product.slug}</span>
              </div>
              <div>
