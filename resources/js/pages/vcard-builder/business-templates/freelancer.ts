...
export const freelancerTemplate = {
  ...
  defaultData: {
    ...
    whatsapp: {
      ...
      cta_text: 'Chat with me on WhatsApp for instant communication!',
      prefilled_message: 'Hi! I found your contact on your business card and would like to discuss a potential project.',
