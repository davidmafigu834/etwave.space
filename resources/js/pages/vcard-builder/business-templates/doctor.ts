...
export const doctorTemplate = {
  ...
  sections: [
    ...
    },
    {
      ...
      fields: [
        { name: 'phone_number', type: 'tel', label: 'WhatsApp Phone Number' },
        { name: 'cta_text', type: 'text', label: 'Call-to-Action Text' },
        { name: 'prefilled_message', type: 'textarea', label: 'Prefilled Message' },
        { name: 'button_label', type: 'text', label: 'Button Label' },
        { name: 'show_icon', type: 'checkbox', label: 'Show WhatsApp Icon' }
      ],
      required: false
    },
    {
  ...
  defaultData: {
    ...
    whatsapp: {
      ...
      cta_text: 'For urgent medical questions or appointment scheduling, message us on WhatsApp!',
      prefilled_message: 'Hello Dr. Johnson, I would like to schedule a consultation regarding my health concerns.',
      button_label: 'WhatsApp Consultation',
      show_icon: true
    },
    custom_html: {
