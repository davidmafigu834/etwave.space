...
export default function Users() {
  ...
  return (
    ...
    >
      ...
      <div className="bg-white/5 border-white/10 text-slate-100 rounded-lg border shadow mb-4 p-4">
        <SearchAndFilterBar
      ...
      {/* Content section */}
      {activeView === 'list' ? (
        <div className="bg-white/5 border-white/10 text-slate-100 rounded-lg border shadow overflow-hidden">
          <CrudTable
            columns={columns}
            actions={actions}
            data={users?.data || []}
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {users?.data?.map((user: any) => (
              <Card key={user.id} className="bg-white/5 border-white/10 text-slate-100 text-slate-100 rounded-lg border shadow">
                {/* Header */}
                <div className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="text-lg font-bold text-slate-100 mb-2">{user.name}</h3>
          ...
          <div className="mt-6 bg-white/5 border-white/10 text-slate-100 rounded-lg border shadow overflow-hidden">
            <Pagination
              from={users?.from || 0}
              to={users?.to || 0}
              total={users?.total || 0}
