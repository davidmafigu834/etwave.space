export const defaultLandingPageSections = {
  sections: [
    ...
    {
      key: 'screenshots',
      title: 'See etwave.space in Action',
    ...
    {
      key: 'newsletter',
      title: 'Stay Updated with etwave.space',
    ...
    },
    {
      key: 'contact',
      title: 'Get in Touch',
      subtitle: 'Have questions about etwave.space? We\'d love to hear from you.',
  ...
  seo: {
    meta_title: 'etwave.space - Digital Business Cards & Professional Networking',
